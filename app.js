...
class Bd{
    ...
    recuperarTodosRegistros(){
       ...
       let id = localStorage.getItem('id')
       //recuperar a todas as despesas cadastradas em localStrorage
       for(let i = 1; i<= id; i++){
        
        let despesa = JSON.parse(localStorage.getItem(i))

//existe a possibilidade de haver indicies pulados ou removidos 
//neste casos vamos pular esses indicies
        if(despesa===null){
            continue
        }
